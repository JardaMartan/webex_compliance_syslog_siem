...
def handle_event(event, wxt_client, syslog_list, syslog_facility, syslog_severity, options, config):
    ...
    try:
        ...
        send_syslog(syslog_list, syslog_msg, process_name = "WEBEX-COMPLIANCE", facility = syslog_facility, severity = syslog_severity)
...
def handle_admin_event(admin_event, wxt_client, syslog_list, syslog_facility, syslog_severity, options, config):
    ...
    try:
        ...
        send_syslog(syslog_list, syslog_msg, process_name = "WEBEX-ADMIN-AUDIT", facility = syslog_facility, severity = syslog_severity)
    except Exception as e:
